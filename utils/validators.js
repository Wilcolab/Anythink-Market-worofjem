...
const validateEmail = (email) => {
  // Step 3: Complete validation with error handling
  ...
  // Step 1: Basic email format regex
...
const validateURL = (url) => {
  ...
  // Step 1: Basic URL regex validation
  ...
  // Step 2: Try to parse with URL constructor
  try {
